...
import Controlador.Dashboard.Dash_GenerarReporte_Evento;
import tabla.evento.Evento;

public class generar_reporte_evento extends javax.swing.JDialog {

    private Evento modelevento;
    private Dash_GenerarReporte_Evento dashGen_RepEvcontroller;

    public void setController(Evento modelevento, Dash_GenerarReporte_Evento dashGen_RepEvcontroller) {
        this.modelevento = modelevento;
        this.dashGen_RepEvcontroller = dashGen_RepEvcontroller;
    }
    
    
    
    public generar_reporte_evento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/reporte/ventana_generar_reporteEvento.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(generar_reporte_evento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                generar_reporte_evento dialog = new generar_reporte_evento(new javax.swing.JFrame(), true);
