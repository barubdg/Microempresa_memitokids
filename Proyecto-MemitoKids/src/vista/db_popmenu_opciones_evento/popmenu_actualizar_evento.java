...
import Controlador.Dashboard.Dash_Evento_ActController;
import tabla.evento.Evento;

public class popmenu_actualizar_evento extends javax.swing.JDialog {

    
    private Evento modelEvento;
    private Dash_Evento_ActController dashEv_Actcontroller;

    public void setController(Evento modelEvento, Dash_Evento_ActController dashEv_Actcontroller) {
        this.modelEvento = modelEvento;
        this.dashEv_Actcontroller = dashEv_Actcontroller;
    }
    
    
    
    public popmenu_actualizar_evento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_actualizar_evento = new javax.swing.JButton();
        ...
        btn_actualizar_evento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_actualizar.png"))); // NOI18N
        btn_actualizar_evento.setBorder(null);
        btn_actualizar_evento.setBorderPainted(false);
        btn_actualizar_evento.setContentAreaFilled(false);
        btn_actualizar_evento.setFocusPainted(false);
        btn_actualizar_evento.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_actualizar_select.png"))); // NOI18N
        jPanel1.add(btn_actualizar_evento, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 515, 230, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_actualizar_evento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_actualizar_evento dialog = new popmenu_actualizar_evento(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JButton btn_actualizar_evento;
