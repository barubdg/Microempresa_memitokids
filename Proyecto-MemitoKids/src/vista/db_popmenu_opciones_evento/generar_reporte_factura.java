...
import Controlador.Dashboard.Dash_GenerarReporte_Factura;
import tabla.evento.Evento;

public class generar_reporte_factura extends javax.swing.JDialog {

    private Evento modelevento;
    private Dash_GenerarReporte_Factura dashGen_RepFacontroller;

    public void setController(Evento modelevento, Dash_GenerarReporte_Factura dashGen_RepFacontroller) {
        this.modelevento = modelevento;
        this.dashGen_RepFacontroller = dashGen_RepFacontroller;
    } 
    
    public generar_reporte_factura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/reporte/ventana_generar_reporteFactura.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(generar_reporte_factura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                generar_reporte_factura dialog = new generar_reporte_factura(new javax.swing.JFrame(), true);
