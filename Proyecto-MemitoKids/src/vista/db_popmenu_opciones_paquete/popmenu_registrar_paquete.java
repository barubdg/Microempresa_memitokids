...
import Controlador.Dashboard.Dash_Paquete_RegController;
import tabla.paquete.Paquete;




public class popmenu_registrar_paquete extends javax.swing.JDialog {

    private Paquete modelPaquete;
    private Dash_Paquete_RegController dashPaq_Regcontroller;

    public void setController(Paquete modelPaquete, Dash_Paquete_RegController dashPaq_Regcontroller) {
        this.modelPaquete = modelPaquete;
        this.dashPaq_Regcontroller = dashPaq_Regcontroller;
    }
    ...
    public popmenu_registrar_paquete(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_registrar_paquete = new javax.swing.JButton();
        ...
        btn_registrar_paquete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar.png"))); // NOI18N
        btn_registrar_paquete.setBorder(null);
        btn_registrar_paquete.setBorderPainted(false);
        btn_registrar_paquete.setContentAreaFilled(false);
        btn_registrar_paquete.setFocusPainted(false);
        btn_registrar_paquete.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar_select.png"))); // NOI18N
        jPanel1.add(btn_registrar_paquete, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 213, 230, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_registrar_paquete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_registrar_paquete dialog = new popmenu_registrar_paquete(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JButton btn_registrar_paquete;
