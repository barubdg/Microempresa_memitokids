...
import Controlador.Dashboard.Dash_Asistencia_VisuController;
import tabla.asistencia.Asistencia;

public class popmenu_visualizar_asistencia extends javax.swing.JDialog {

    private Asistencia modelAsistencia;
    private Dash_Asistencia_VisuController dashEvAs_Visucontroller;

    public void setController(Asistencia modelAsistencia, Dash_Asistencia_VisuController dashEvAs_Visucontroller) {
        this.modelAsistencia = modelAsistencia;
        this.dashEvAs_Visucontroller = dashEvAs_Visucontroller;
    }
    
    
    public popmenu_visualizar_asistencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_cancelar_asistencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(325, 213, 230, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_visualizar_asistencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_visualizar_asistencia dialog = new popmenu_visualizar_asistencia(new javax.swing.JFrame(), true);
