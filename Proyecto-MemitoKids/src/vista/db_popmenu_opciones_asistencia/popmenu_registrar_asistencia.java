...
import Controlador.Dashboard.Dash_Asistencia_RegController;
import tabla.asistencia.Asistencia;

public class popmenu_registrar_asistencia extends javax.swing.JDialog {

    private Asistencia modelAsistencia;
    private Dash_Asistencia_RegController dashEvAs_Regcontroller;

    public void setController(Asistencia modelAsistencia, Dash_Asistencia_RegController dashEvAs_Regcontroller) {
        this.modelAsistencia = modelAsistencia;
        this.dashEvAs_Regcontroller = dashEvAs_Regcontroller;
    }
    
    
    
    
    public popmenu_registrar_asistencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btn_registrar_asistencia = new javax.swing.JButton();
        ...
        btn_registrar_asistencia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar.png"))); // NOI18N
        btn_registrar_asistencia.setBorder(null);
        btn_registrar_asistencia.setBorderPainted(false);
        btn_registrar_asistencia.setContentAreaFilled(false);
        btn_registrar_asistencia.setFocusPainted(false);
        btn_registrar_asistencia.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar_select.png"))); // NOI18N
        jPanel1.add(btn_registrar_asistencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 213, 230, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_registrar_asistencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_registrar_asistencia dialog = new popmenu_registrar_asistencia(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JButton btn_registrar_asistencia;
