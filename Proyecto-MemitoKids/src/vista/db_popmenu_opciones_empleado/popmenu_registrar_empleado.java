...
public class popmenu_registrar_empleado extends javax.swing.JDialog {

    private Empleado modelEmpleado;
    private Dash_Empleado_RegController dashEmpl_Regcontroller;

    public void setController(Dash_Empleado_RegController dashEmpl_Regcontroller, Empleado modelEmpleado) {
        this.dashEmpl_Regcontroller = dashEmpl_Regcontroller;
    ...
    public popmenu_registrar_empleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();    
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_cancelar_empleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 515, 230, 50));

        btn_registrar_empleado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar.png"))); // NOI18N
        btn_registrar_empleado.setBorder(null);
        btn_registrar_empleado.setBorderPainted(false);
        btn_registrar_empleado.setContentAreaFilled(false);
        btn_registrar_empleado.setFocusPainted(false);
        btn_registrar_empleado.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_registrar_select.png"))); // NOI18N
        jPanel1.add(btn_registrar_empleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 515, 230, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/empleado/img_registrarse.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_registrar_empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_registrar_empleado dialog = new popmenu_registrar_empleado(new javax.swing.JFrame(), true);
