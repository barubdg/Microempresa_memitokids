...
import Controlador.Dashboard.Dash_Cliente_VisuController;
import tabla.cliente.Cliente;




public class popmenu_visualizar_cliente extends javax.swing.JDialog {

    private Cliente modelCliente;
    private Dash_Cliente_VisuController dashCli_Visucontroller;
    
    public void setController(Dash_Cliente_VisuController dashCli_Visucontroller, Cliente modelCliente) {
        this.dashCli_Visucontroller = dashCli_Visucontroller;
        this.modelCliente = modelCliente;
    }
    
    public popmenu_visualizar_cliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_visualizar_cliente = new javax.swing.JButton();
        ...
        jPanel1.add(btn_cancelar_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(728, 515, 230, 50));

        btn_visualizar_cliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_visualizar.png"))); // NOI18N
        btn_visualizar_cliente.setBorder(null);
        btn_visualizar_cliente.setBorderPainted(false);
        btn_visualizar_cliente.setContentAreaFilled(false);
        btn_visualizar_cliente.setFocusPainted(false);
        btn_visualizar_cliente.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_visualizar_select.png"))); // NOI18N
        jPanel1.add(btn_visualizar_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(463, 515, 230, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cliente/img_visualizar.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_visualizar_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_visualizar_cliente dialog = new popmenu_visualizar_cliente(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JButton btn_visualizar_cliente;
