...
import Controlador.Dashboard.Dash_Cliente_ActController;
import tabla.cliente.Cliente;



public class popmenu_actualizar_cliente extends javax.swing.JDialog {

    private Cliente ModelCliente;
    private Dash_Cliente_ActController dashCli_Actcontroller;
    
    public void setController(Dash_Cliente_ActController dashCli_Actcontroller, Cliente ModelCliente) {
        this.dashCli_Actcontroller = dashCli_Actcontroller;
        this.ModelCliente = ModelCliente;
    }    
    
    
    
    public popmenu_actualizar_cliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();        
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cliente/img_actualizar.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_actualizar_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_actualizar_cliente dialog = new popmenu_actualizar_cliente(new javax.swing.JFrame(), true);
