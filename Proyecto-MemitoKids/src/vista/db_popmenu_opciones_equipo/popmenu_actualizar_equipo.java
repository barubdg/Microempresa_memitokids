...
import Controlador.Dashboard.Dash_Equipo_ActController;
import tabla.equipo_organizacion.Equipo_Organizacion;


public class popmenu_actualizar_equipo extends javax.swing.JDialog {

    private Equipo_Organizacion modelEquipo;
    private Dash_Equipo_ActController dashEvEq_Actcontroller;

    public void setController(Equipo_Organizacion modelEquipo, Dash_Equipo_ActController dashEvEq_Actcontroller) {
        this.modelEquipo = modelEquipo;
        this.dashEvEq_Actcontroller = dashEvEq_Actcontroller;
    }
    
    public popmenu_actualizar_equipo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_equipoid = new javax.swing.JLabel();
        ...
        btn_actualizar_equipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_actualizar.png"))); // NOI18N
        btn_actualizar_equipo.setBorder(null);
        btn_actualizar_equipo.setBorderPainted(false);
        btn_actualizar_equipo.setContentAreaFilled(false);
        btn_actualizar_equipo.setFocusPainted(false);
        btn_actualizar_equipo.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botones_opciones_generales/btn_actualizar_select.png"))); // NOI18N
        jPanel1.add(btn_actualizar_equipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 213, 230, 50));
        ...
        txt_equipoid.setText("jLabel2");
        jPanel1.add(txt_equipoid, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popmenu_actualizar_equipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popmenu_actualizar_equipo dialog = new popmenu_actualizar_equipo(new javax.swing.JFrame(), true);
